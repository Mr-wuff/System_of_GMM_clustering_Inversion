...
Small-scale data (less than 1000 points) ```python
...
Medium-sized data (1000 - 10000 points) ```python
Parameter configuration:
Cluster level: 8-12
...
Large-scale data (more than 10,000 points) ```python
Parameter configuration:
Cluster level: 10 - 15
